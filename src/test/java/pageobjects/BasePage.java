...
public class BasePage extends DriverFactory {
   ...
   //WAIT METHODS
    ...
    public static void copyLatestExtentReport() throws IOException {
        ...
        File dest = new File(System.getProperty("user.dir") + "/test-output/ArchivedReports/" + date + ".html");
    ...
    public static void FileCopyExample() {
        ...
        try {
            FileReader fr = new FileReader(System.getProperty("user.dir") + "/test-output/HtmlReport/ExtentHtml.html");
            BufferedReader br = new BufferedReader(fr);
            FileWriter fw = new FileWriter(System.getProperty("user.dir") + "/test-output/HtmlReport/ExtentHtml.html1", true);
            String s;
